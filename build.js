...
<html lang="en">
  <head>
    ...
    <title>RoofMaster 360</title>
    <link rel="icon" href="/assets/images/icon.png" type="image/png">
    <style id="expo-reset">
      html, body { height: 100%; margin: 0; padding: 0; }
      body { overflow: hidden; background: linear-gradient(135deg, #1A2332 0%, #151D28 100%); }
  ...
  <body>
    ...
    <div id="root"></div>
    <script src="${baseUrl}/${timestamp}/_expo/static/js/web/bundle.js" defer></script>
  </body>
</html>`;
  fs.writeFileSync(path.join("static-build", "web", "index.html"), webIndexHtml);
